...
public class SoutConfiguration {
     ...
     * @param customTypeRenderer a list of {@link CustomTypeRenderer} that will be asked if they can render a specific type (class) that was encountered in the model. Can be null, meaning no special type rendering.
     */
    public SoutConfiguration(
        ...
        this.customNameRenderer = customNameRenderer == null ? (model, name, outputWriter) -> false : customNameRenderer;
        this.customTypeRenderer = customTypeRenderer == null ? (model, outputWriter) -> false : customTypeRenderer;
    }
}
